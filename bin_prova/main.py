...
def main():
    ...
    f = open("experiment_folder.txt", 'w')
    ...
    mrn, encoded, metrics_avg = train_and_evaluate(model, data_generator, loss_fn, optimizer, experiment_folder, metrics, experiment_folder)
